...
export default function ChangePasswordForm(props){
    ...
    const onSubmit =  async () => {
                ...
                .then(async () => {
                    await firebase
                        ...
                        .then(() => {
                            ...
                            setIsLoading(false);
                            setShowModal(false);
                            firebase.auth().signOut(); //aqui se desmonta el componente
                        })
                        .catch(() => {
                            errorTemp= {
        ...
        /* si todo sale ok, la sesion se cierra y se desmonta el componente, entonces no puede actualizar
        los errores. Por eso verifico contra itSetError */
